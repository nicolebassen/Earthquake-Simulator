...
public class SaveDialog extends Dialog
{
    ...
    public SaveDialog(Frame frame, EpicenterMagnitude epicentermagnitude, StringServer stringserver)
    {
        super(frame, stringserver.getString("Save"), true);
        listener = null;
        applet = null;
        okClicked = false;
        stringServer = null;
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent windowevent)
            {
                okClicked = false;
                setVisible(false);
                listener.dialogClosed(SaveDialog.this);
            }

        }
);
        Label label = new Label(stringserver.getString("save_what_would"), 1);
    ...
    private void addCheckboxes(int i, int j)
    {
        ...
        int k = fontmetrics.stringWidth("Travel-Time Graph") + 20;
        int l = (i - k) / 2;
        int i1 = fontmetrics.getHeight() + 8;
        mainAreaCheckbox = new Checkbox(stringServer.getString("Map"), false);
        journalCheckbox = new Checkbox(stringServer.getString("tab_journal"), false);
        ...
        sessionCheckbox = new Checkbox(stringServer.getString("Session"), true);
        ...
        sessionCheckbox.setFont(normalFont);
        ...
        sessionCheckbox.setBounds(l, j + i1 * 6, k, i1);
    }
